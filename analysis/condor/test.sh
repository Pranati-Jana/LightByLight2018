...
inputPath="/eos/cms/store/group/phys_heavyions/pjana/Pranati_ForDiTau_Analysis/GammaGammatoMuMu_5p02TeV_STARlight/reco_mc_StarLight/240509_162030/0000/mc_HiForestAOD_${1}.root"
outputPath="/eos/user/p/pjana/RootFileTauTau/AllSelections_FromSelectEleMuScript/CutFlowHistAdded_18thMarch/MuonEndcapPt1.5GeV_HE1To3DeltaRMuonHE1/GammaGammaToMuMu${suffix}"
elif [ $2 -eq 4 ]
then
  sampleName="MUMU_FSR"
...
then
  ...
  ${userBasePath}/selectMuMuEvents $configPath $inputPath $output $sampleName
fi
