...
// Sun Feb 18 20:53:45 2024 by ROOT version 6.28/06
// from TTree output_tree/
// found on file: After_Dielectron/WithTrigger/Data_QED.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("After_Dielectron/WithTrigger/Data_QED.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("After_Dielectron/WithTrigger/Data_QED.root");
      }
