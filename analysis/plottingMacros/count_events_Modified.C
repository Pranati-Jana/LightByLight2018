...
double lumiNormSC_FSR = xsecGeneratedSC_FSR*luminosity*scaleFactorsSC_FSR_Old/nEventsGeneratedSC_FSR;
...
double normSC_LbL = scaleFactorPhoton_Old*xsecGeneratedLbLSC*luminosity/nEventsGeneratedLbLSC;

const double xsecGeneratedCEPIncoh    = 0.001431; // μb
const double nEventsGeneratedCEPIncoh = 500000;
double norm_CEPIncoh = scaleFactorPhoton_Old*xsecGeneratedCEPIncoh*luminosity/nEventsGeneratedCEPIncoh;


void count_events_Modified(){
...
//
  ...
  //data->Add("After_Diphoton/Data_diphoton.root");
...
//
   ...
   const TCut no_extrk  = " ok_chexcl_goodtracks==1 && ok_chexcl_goodelectrons==1 && phoSwissCross_1 < 0.95 && phoSwissCross_2 < 0.95";
  ...
  data->Project(hmass_data_acop->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5 && vSum_Pt<1 && pho_acop<0.01" );
  ...
  mcsc_fsr->Project(hmass_mcsc_fsr_inv->GetName(),"vSum_M","vSum_M>5");
  mcsc_fsr->Project(hmass_mcsc_fsr_ch->GetName(), "vSum_M",no_extrk && "vSum_M>5");
  mcsc_fsr->Project(hmass_mcsc_fsr_neu->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5" );
  mcsc_fsr->Project(hmass_mcsc_fsr_pt->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5 && vSum_Pt<1" );
  mcsc_fsr->Project(hmass_mcsc_fsr_acop->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5 && vSum_Pt<1 && pho_acop<0.01" );
  hmass_mcsc_fsr_ch->Scale(lumiNormSC_FSR);  hmass_mcsc_fsr_neu->Scale(lumiNormSC_FSR); hmass_mcsc_fsr_inv->Scale(lumiNormSC_FSR);  
  ...
  mc_CEPIncoh->Project(hmass_mc_CEPIncoh_inv->GetName(),"vSum_M","vSum_M>5");
  mc_CEPIncoh->Project(hmass_mc_CEPIncoh_ch->GetName(), "vSum_M",no_extrk && "vSum_M>5");
  mc_CEPIncoh->Project(hmass_mc_CEPIncoh_neu->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5" );
  mc_CEPIncoh->Project(hmass_mc_CEPIncoh_pt->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5 && vSum_Pt<1" );
  mc_CEPIncoh->Project(hmass_mc_CEPIncoh_acop->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5 && vSum_Pt<1 && pho_acop<0.01" );

  
  hmass_mc_CEPIncoh_ch->Scale(norm_CEPIncoh);  hmass_mc_CEPIncoh_neu->Scale(norm_CEPIncoh); hmass_mc_CEPIncoh_inv->Scale(norm_CEPIncoh);  
  ...
  mcsc_lbyl->Project(hmass_mcsc_lbyl_inv->GetName(), "vSum_M","vSum_M>5");
  mcsc_lbyl->Project(hmass_mcsc_lbyl_ch->GetName(), "vSum_M",no_extrk && "vSum_M>5");
  mcsc_lbyl->Project(hmass_mcsc_lbyl_neu->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5");
  mcsc_lbyl->Project(hmass_mcsc_lbyl_pt->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5 && vSum_Pt<1" );
  mcsc_lbyl->Project(hmass_mcsc_lbyl_acop->GetName(), "vSum_M",no_extrk && no_addittional_tower && "vSum_M>5 && vSum_Pt<1 && pho_acop<0.01" );
  hmass_mcsc_lbyl_ch->Scale(normSC_LbL);  hmass_mcsc_lbyl_neu->Scale(normSC_LbL); hmass_mcsc_lbyl_inv->Scale(normSC_LbL);
  hmass_mcsc_lbyl_pt->Scale(normSC_LbL);   hmass_mcsc_lbyl_acop->Scale(normSC_LbL);

  
  cout << "diele m >5   & " <<  hmass_data_inv->Integral() <<"  &  " << hmass_mcsc_lbyl_inv->Integral() <<"  &  " << hmass_mcsc_fsr_inv->Integral() << "   &   " << hmass_mc_CEPIncoh_inv->Integral() << endl;  
