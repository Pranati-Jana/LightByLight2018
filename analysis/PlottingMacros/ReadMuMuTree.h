...
// Wed Jan 22 10:24:35 2025 by ROOT version 6.28/06
// from TTree output_tree/
// found on file: RootFile_From_selectEleMuEvents/ForTriggerHFveto_SF_Study_ggmumu/mc_mumu_ChFF_HFveto_SF_dRL1Muon.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   TBranch        *b_ok_singleMuon_noHFveto;   //!
   ...
   TBranch        *b_vSum_Pz;   //!
   TBranch        *b_tower_eta;   //!
   TBranch        *b_tower_etap;   //!
   TBranch        *b_tower_etam;   //!
   TBranch        *b_tower_phi;   //!
   TBranch        *b_tower_em;   //!
   TBranch        *b_tower_had;   //!
   TBranch        *b_tower_HFp;   //!
   ...
   TBranch        *b_deltaR_muon_L1muon;   //!
   TBranch        *b_dR_L1muon1;   //!
   TBranch        *b_dR_L1muon2;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("RootFile_From_selectEleMuEvents/ForTriggerHFveto_SF_Study_ggmumu/mc_mumu_ChFF_HFveto_SF_dRL1Muon.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("RootFile_From_selectEleMuEvents/ForTriggerHFveto_SF_Study_ggmumu/mc_mumu_ChFF_HFveto_SF_dRL1Muon.root");
      }
...
void ReadMuMuTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("ok_singleMuon_noHFveto", &ok_singleMuon_noHFveto, &b_ok_singleMuon_noHFveto);
   ...
   fChain->SetBranchAddress("tower_etap", &tower_etap, &b_tower_etap);
   fChain->SetBranchAddress("tower_etam", &tower_etam, &b_tower_etam);
   ...
   fChain->SetBranchAddress("tower_HFp", &tower_HFp, &b_tower_HFp);
   fChain->SetBranchAddress("tower_HFm", &tower_HFm, &b_tower_HFm);
   ...
   fChain->SetBranchAddress("deltaR_muon_L1muon", &deltaR_muon_L1muon, &b_deltaR_muon_L1muon);
   fChain->SetBranchAddress("dR_L1muon1", &dR_L1muon1, &b_dR_L1muon1);
   fChain->SetBranchAddress("dR_L1muon2", &dR_L1muon2, &b_dR_L1muon2);
   Notify();
}
